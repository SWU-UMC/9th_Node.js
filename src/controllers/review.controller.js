    ...
    content: {
      "application/json": {
        schema: {
          type: "object",
          properties: {
            mission_id: { type: "number", example: 3 },
            restaurant_id: { type: "number", example: 10 },
            user_id: { type: "number", example: 5 },
            rating: { type: "number", example: 5 },
            content: { type: "string", example: "정말 맛있게 먹었어요" },
            photo: { type: "string", example: null },
            restaurant_name: { type: "string", example: "가게이름a" }
          }
        }
      }
    }
