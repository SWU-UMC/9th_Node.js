          ...
          properties: {
            ...
            error: {
              ...
              properties: {
                ...
                reason: { type: "string", example: "인증 토큰이 없거나 유효하지 않습니다." }
                }
              },
              success: { type: "object", nullable: true, example: null }
              }
          ...
          properties: {
            ...
            error: {
              ...
              properties: {
                ...
                reason: { type: "string", example: "해당 ID의 레스토랑 또는 사용자를 찾을 수 없습니다." }
                }
              },
              success: { type: "object", nullable: true, example: null }
              }
          ...
          properties: {
            ...
            error: {
              ...
              properties: {
                ...
                reason: { type: "string", example: "리뷰 등록 중 예기치 않은 서버 오류가 발생했습니다." }
                }
              },
              success: { type: "object", nullable: true, example: null }
              }
        ...
        schema: {
          ...
          properties: {
            ...
            error: {
              ...
              properties: {
                errorCode: { type: "string", example: "NOT_FOUND" },
                reason: { type: "string", example: "해당 user_id를 가진 사용자를 찾을 수 없습니다." }
                }
              },
              success: { type: "object", nullable: true, example: null }
              }
        ...
        schema: {
          ...
          properties: {
            ...
            error: {
              ...
              properties: {
                errorCode: { type: "string", example: "INTERNAL_SERVER_ERROR" },
                reason: { type: "string", example: "리뷰 목록 조회 중 예기치 않은 서버 오류가 발생했습니다." }
                }
              },
              success: { type: "object", nullable: true, example: null }
              }
